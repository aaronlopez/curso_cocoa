...
$(TeamIdentifierPrefix)com.yourcompany.yourAppName
...
The entitlements file also include the key "com.apple.developer.ubiquity-kvstore-identifier".  Like the above, you need to change it to fit your Team ID and identifier.
...
- An entitlements file containing the ubiquity container identifier which includes the Team ID (or company/organization ID), and identifier for your key-value store.

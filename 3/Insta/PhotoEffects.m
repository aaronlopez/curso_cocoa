...
- (void)viewDidLoad
{
    ...
    [self.scrollView setContentSize:CGSizeMake(500,101)];
    [self takePhoto];
    self.filters=[[NSArray alloc] initWithObjects:@"CISepiaTone",@"CIBloom",@"CIColorMonochrome",@"CIHoleDistortion",@"CICMYKHalftone",@"CIColorInvert", nil ];
}
